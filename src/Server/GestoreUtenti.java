...
public class GestoreUtenti
{
    ...
    public static void aggiornaLista()
    {
        ...
        try
        {
            File f = new File(Server.dirPath + fileName);
    ...
    public static void rimuovi(Utente utente)
    {
        ListaUtenti.removeElement(utente);
    }

    public static void rimuovi(int posizioneUtente)
    {
        ListaUtenti.removeElementAt(posizioneUtente);
    }
